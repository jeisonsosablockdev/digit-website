...
| 2 | `frontend` | Define the SSR/client split and server trust boundary | Client-only code and server-side validation points are explicit |
...
| 6 | `qa` | Run targeted tests, Playwright, and browser evidence as required | Workflow-specific gates pass with deterministic artifacts |
